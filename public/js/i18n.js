...
export const translations = {
  es: {
    ...
    unverifiedReport: "Reporte ciudadano no verificado. Usa esta informacion con precaucion.",
    ...
    reportIncidentHelp: "Registra un punto de incidente vial. La informacion sera visible como reporte ciudadano no verificado.",
    reportName: "Nombre",
    ...
    reportTypeClosedRoad: "Via cerrada",
    reportTypeObstacle: "Obstaculo",
    reportTypeFlood: "Inundacion",
    reportTypeOther: "Otro",
    reportProvince: "Provincia",
    reportCanton: "Canton",
    reportParish: "Parroquia",
    reportLocation: "Ubicacion del incidente",
    ...
    reportUseCurrentLocation: "Usar mi ubicacion",
    reportPickOnMap: "Elegir en el mapa",
    reportLocationPending: "Selecciona una ubicacion para continuar.",
    reportLocationSelected: "Ubicacion seleccionada",
    reportDescription: "Descripcion",
    reportResponsibility: "Confirmo que el reporte es responsable y entiendo que sera mostrado como informacion ciudadana no verificada.",
    ...
    reportLocationRequired: "Selecciona la ubicacion del incidente.",
    reportPickHint: "El formulario se ocultara. Haz clic en el mapa para marcar el punto del incidente.",
    reportGettingLocation: "Buscando tu ubicacion...",
    reportLocationReady: "Ubicacion lista para el reporte.",
    reportGpsDenied: "Permiso de ubicacion denegado. Puedes elegir el punto en el mapa.",
    reportGpsError: "No se pudo obtener tu ubicacion. Elige el punto en el mapa.",
    locationUnsupported: "Este navegador no soporta ubicacion.",
    cancel: "Cancelar",
